...
public class FedexRecyclerViewAdapter extends RecyclerView.Adapter<FedexRecyclerViewAdapter.SimpleViewHolder> {
    ...
    public FedexRecyclerViewAdapter(Context context, ArrayList<ListContent> objects, Activity mainActivity) {
    ...
    public SimpleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fedex_row, parent, false);
        ...
        holder.detail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (holder.detail.getText().equals("Show More")) {
                    ...
                    holder.webView.loadUrl("https://www.fedex.com/apps/fedextrack/?action=track&tracknumbers=" + currentListContent.getTrackingNo().toString().trim() + "&locale=en_IN&cntry_code=in");
